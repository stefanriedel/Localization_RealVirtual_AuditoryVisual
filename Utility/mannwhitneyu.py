...
def stats_mannwhitneyu(x, y, use_continuity=True, alternative="two-sided",
                 axis=0, method="auto"):
    ...
    *p*-value produced using the normal approximation.
    ...
    effect_size = z / np.sqrt(x.size)
    effect_size = np.clip(effect_size, -1, 1)


    return MannwhitneyuResult(U1, p), effect_size
